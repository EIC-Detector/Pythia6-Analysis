			 ...
			 )
{
  ...
  TCut proton_cut = "particles.fPdgCode == 2212";
  TCut neutron_cut = "particles.fPdgCode == 2112";
  TCut Kaon_cut = "abs(particles.fPdgCode) == 321 || particles.fPdgCode == 311";
  TCut Pion_charged_cut = "abs(particles.fPdgCode) == 211";
  //TCut Pion_cut = "abs(particles.fPdgCode) == 211 || particles.fPdgCode == 111";
  TCut photon_cut = "particles.fPdgCode == 22";
  
  TCut mother_cut = "particles.fMother[][0] == 1";
  TCut status_cut = "particles.fStatusCode < 10";
  ...
  TCut eta_cut_n2n1 = "TMath::ASinH(particles.fPz/sqrt((particles.fPx)**2 + (particles.fPy)**2)) > -2 && TMath::ASinH(particles.fPz/sqrt((particles.fPx)**2 + (particles.fPy)**2)) < -1";
  TCut eta_cut_n1z0 = "TMath::ASinH(particles.fPz/sqrt((particles.fPx)**2 + (particles.fPy)**2)) > -1 && TMath::ASinH(particles.fPz/sqrt((particles.fPx)**2 + (particles.fPy)**2)) < -0";
  ...
  T->Draw("sqrt((particles.fPx)**2 + (particles.fPy)**2 + (particles.fPz)**2 ):TMath::ASinH(particles.fPz/sqrt((particles.fPx)**2 + (particles.fPy)**2))>>h_peta_e", electron_cut && mother_cut && "Q2 > 1", "colz");
  ...
  T->Draw("sqrt((particles.fPx)**2 + (particles.fPy)**2 + (particles.fPz)**2 ):TMath::ASinH(particles.fPz/sqrt((particles.fPx)**2 + (particles.fPy)**2))>>h_p_eta_h",hadron_cut && "Q2 > 1 && 0.01 < y < 0.80 && W2 > 10", "colz");
  ...
  TH2F *h_peta_y = new TH2F("h_peta_y", "", 40, -4, 4, 50, 0, 30);

  TCanvas *c_peta_y = new TCanvas( "c_peta_y" );
  T->Draw("sqrt((particles.fPx)**2 + (particles.fPy)**2 + (particles.fPz)**2 ):TMath::ASinH(particles.fPz/sqrt((particles.fPx)**2 + (particles.fPy)**2))>>h_peta_y", photon_cut && status_cut && "0.01 < y < 0.95", "colz");

  h_peta_y->GetXaxis()->SetTitle("Pseudorapidity #eta");
  h_peta_y->GetYaxis()->SetTitle("Photon Momentum p_{#gamma} [GeV]");
  c_peta_y->SetLogz();
  ...
  T->Draw("sqrt(particles.fPx**2 + particles.fPy**2 + particles.fPz**2)>>hp_e_n3n2", electron_cut && eta_cut_n3n2 && "Q2 > 0.01", "goff");
  T->Draw("sqrt(particles.fPx**2 + particles.fPy**2 + particles.fPz**2)>>hp_p_n3n2", Pion_charged_cut && eta_cut_n3n2 && "Q2 > 0.01", "goff");
  T->Draw("sqrt(particles.fPx**2 + particles.fPy**2 + particles.fPz**2)>>hp_y_n3n2", photon_cut && eta_cut_n3n2 && status_cut && "Q2 > 0.01", "goff");
  ...
  T->Draw("sqrt(particles.fPx**2 + particles.fPy**2 + particles.fPz**2)>>hp_e_n2n1", electron_cut && eta_cut_n2n1 && "Q2 > 0.01", "goff");
  T->Draw("sqrt(particles.fPx**2 + particles.fPy**2 + particles.fPz**2)>>hp_p_n2n1", Pion_charged_cut && eta_cut_n2n1 && "Q2 > 0.01", "goff");
  T->Draw("sqrt(particles.fPx**2 + particles.fPy**2 + particles.fPz**2)>>hp_y_n2n1", photon_cut && eta_cut_n2n1 && status_cut && "Q2 > 0.01", "goff");
  ...
  T->Draw("sqrt(particles.fPx**2 + particles.fPy**2 + particles.fPz**2)>>hp_e_n1z0", electron_cut && eta_cut_n1z0 && "Q2 > 0.01", "goff");
  T->Draw("sqrt(particles.fPx**2 + particles.fPy**2 + particles.fPz**2)>>hp_p_n1z0", Pion_charged_cut && eta_cut_n1z0 && "Q2 > 0.01", "goff");
  T->Draw("sqrt(particles.fPx**2 + particles.fPy**2 + particles.fPz**2)>>hp_y_n1z0", photon_cut && eta_cut_n1z0 && status_cut && "Q2 > 0.01", "goff");
